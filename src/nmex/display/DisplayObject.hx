...
{
   public var graphics(nmeGetGraphics,null) : nmex.display.Graphics;
   ...
   private var tempScaleX:Float;
   private var tempScaleY:Float;
   private var tempAlpha:Float;
   ...
   public function nmeGetGraphics() : nmex.display.Graphics
   {
      if (nmeGraphicsCache==null)
         nmeGraphicsCache = new nmex.display.Graphics( nme_display_object_get_grapics(nmeHandle) );
   ...
   function nmeGetX() : Float { return tempX;/*nme_display_object_get_x(nmeHandle) / Device.scaleFactor();*/ }
   function nmeSetX(inVal:Float) : Float
   {
	  tempX = inVal;
	  inVal *=  Device.scaleFactor();
      nme_display_object_set_x(nmeHandle,inVal);
      return inVal;
   }

   function nmeGetY() : Float { return tempY;/*nme_display_object_get_y(nmeHandle) / Device.scaleFactor();*/ }
   ...
   function nmeGetScaleX() : Float { return tempScaleX;/*nme_display_object_get_scale_x(nmeHandle);*/ }
   ...
   function nmeGetScaleY() : Float { return tempScaleY;/*nme_display_object_get_scale_y(nmeHandle);*/ }
   ...
   function nmeGetMouseX() : Float { return nme_display_object_get_mouse_x(nmeHandle) / Device.scaleFactor(); }
   function nmeGetMouseY() : Float { return nme_display_object_get_mouse_y(nmeHandle) / Device.scaleFactor(); }
   ...
   function nmeGetWidth() : Float { return (nme_display_object_get_width(nmeHandle) / Device.scaleFactor()); }
   ...
   function nmeGetHeight() : Float {
	return (nme_display_object_get_height(nmeHandle) / Device.scaleFactor()); 
	}
   ...
   { 
      ...
      rect.x = rect.x / Device.scaleFactor();
	  rect.y = rect.y / Device.scaleFactor();
	  rect.width = rect.width / Device.scaleFactor();
	  rect.height = rect.height / Device.scaleFactor();
      return rect;
   }
   ...
   {
      return tempAlpha;/*nme_display_object_get_alpha(nmeHandle);*/
   }
